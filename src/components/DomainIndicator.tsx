...
export function DomainIndicator() {
  const { configName, hasCustomization, settings, hostname, isHydrated } = useDomainSettings();
      ...
      <PopoverContent className="w-80 p-4" align="end">
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <span className="text-xs text-muted-foreground">Theme Preview:</span>
          ...
          <div className="pt-2 border-t">
            <div className="text-xs text-muted-foreground">
              💡 These settings are applied automatically when you visit this domain for the first time
            </div>
          </div>
        </div>
      </PopoverContent>
