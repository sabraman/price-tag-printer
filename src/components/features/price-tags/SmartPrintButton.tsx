...
import { FileDown, Printer, ChevronDown, Download } from 'lucide-react';
...
export function SmartPrintButton({ 
  ...
  const primaryButtonText = browserInfo.recommendedMethod === 'browser' 
    ? 'Распечатать' 
    : 'Скачать PDF';
  
  const primaryButtonIcon = browserInfo.recommendedMethod === 'browser' 
